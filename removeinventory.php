...
if (isset($_POST["inventory"])) {
   ...
   $sql_query =mysqli_query($conn,"DELETE FROM cabinetlist where cabinet_id='$inventory'");

for($x = 1; $x <= 9; $x++)
{
   $sql =mysqli_query($conn,"DELETE FROM cabinet where cabinet_id='$inventory' and com_id='$x'");
